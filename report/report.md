...
## Содержание
- [Класс Bits](../src/Bits.cpp) - основной класс с реализацией всех алгоритмов
- [Тесты TestCounts и TestBitboard](../src/test.cpp) - модульное тестирование 
- [Консольный вывод тестирования](../src/output.txt) - результаты всех тестов
